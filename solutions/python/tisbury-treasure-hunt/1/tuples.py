...
def clean_up(combined_record_group):
    ...
    for record in combined_record_group:
        # A compatible record tuple layout:
        # (treasure, azara_coord, location, (rui_coord_1, rui_coord_2), quadrant)
        treasure, _, location, rui_coord, quadrant = record
        report += f"{(treasure, location, rui_coord, quadrant)}\n"
    return report