...
class MeteredFile(io.BufferedRandom):
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        # Return the result of the superclass __exit__ to properly forward exception suppression state
...
class MeteredSocket:
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        # Return the result of the underlying socket's __exit__ to properly forward exception suppression state
