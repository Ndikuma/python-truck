...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # Calculate the total value after exchange
    total_value = budget / actual_rate
    
    # Calculate how many whole bills can be obtained
    number_of_bills = int(total_value // denomination)
    
    # Return the total value in whole bills only
